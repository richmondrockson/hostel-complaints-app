      ...
      <div className="ad-root">
        ...
        <div className="ad-main">
          ...
          <main className="ad-content">
                    ...
                    filtered.map((c) => (
                      ...
                      >
                        ...
                        <div className="ad-complaint-right">
                          <span className="ad-complaint-date">
            ...
            {/* ── Notices view ── */}
            {activeNav === "notices" && <NoticesManager />}
          </main>
        </div>
      </div>
      ...
      {selectedComplaint && (
        <UpdateComplaintModal
          ...
          onUpdated={(updatedId, newStatus, adminNote) => {
            setComplaints((prev) =>
              prev.map((c) =>
                c.id === updatedId ? { ...c, status: newStatus, adminNote } : c,
              ),
            );
...
// ── Update Complaint Modal ────────────────────────────────
function UpdateComplaintModal({ complaint, onClose, onUpdated }) {
      ...
      >
        <div className="ucm-modal">
          ...
          <div className="ucm-footer">
            <button className="ucm-cancel" onClick={onClose}>
              Cancel
            </button>
            <button
              className="ucm-save"
            ...
            >
              {saving ? (
                <>
                  <span className="ucm-spinner" /> Saving...
                </>
              ) : (
                "Save Changes"
              )}
...
function NoticesManager() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      {showForm && <CreateNoticeModal onClose={() => setShowForm(false)} />}
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span style={{ fontSize: 16, fontWeight: 700, color: "#1a2e2e" }}>
            Create Notice
          </span>
          <button
            onClick={onClose}
        ...
        >
          ...
          {[
            ...
            },
            {
              label: "Scope",
              name: "scope",
              placeholder: "e.g. Block A, All Hostels",
            },
          ].map((f) => (
            <div key={f.name}>
              <label
          ...
          >
            <input
              ...
              onChange={handleChange}
              style={{ accentColor: "#2dbdaa", width: 15, height: 15 }}
            />
