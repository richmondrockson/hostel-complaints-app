  ...
  return (
    ...
    >
      ...
      {category?.toLowerCase() === "maintenance" && (
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
          <path
            d="M14.5 3.5l-2 2-2-2 2-2 2 2zM3.5 14.5l7-7M12 6l2.5 2.5-7 7L5 13l7-6.5z"
            stroke={c.stroke}
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
...
export default function Notices({ notices = [] }) {
  ...
  const filtered = useMemo(() => {
    return notices.filter((n) => {
      const matchesFilter =
        activeFilter === "all" || n.category?.toLowerCase() === activeFilter;
              ...
              >
                ...
                {f.value !== "all" && (
                  <span style={{ marginLeft: "6px", opacity: 0.8 }}>
                    ...
                    {
                      notices.filter(
                        (n) => n.category?.toLowerCase() === f.value,
                      ).length
                    }
                    )
                  </span>
          ...
          <div className="nt-empty">
            <div className="nt-empty-icon">
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                <path
                  d="M11 1.5A5.5 5.5 0 005.5 7v4.5L3.5 14h15l-2-2.5V7A5.5 5.5 0 0011 1.5z"
                  stroke="#2dbdaa"
                  strokeWidth="1.5"
                  strokeLinejoin="round"
                />
                <path
                  d="M8.5 14a2.5 2.5 0 005 0"
                  stroke="#2dbdaa"
                  strokeWidth="1.5"
                />
              </svg>
