 ...
 *
 * WHAT THIS IS:
 * The profile view rendered inside the Dashboard when the student
 * clicks "Profile" in the sidebar.
 *
 * HOW DATA WORKS:
 * - Firebase Auth gives us: email, displayName, uid
 * - Firestore "users" collection gives us: everything else
 * - Document ID in "users" = user.uid (one doc per student)
 * - If no profile doc exists yet, we show empty states with prompts to fill in
 *
 * PROPS:
 * - user: Firebase Auth user object (from Dashboard)
 * - complaints: array of complaints (from Dashboard) — for stats and recent list
 */
      ...
      <div className="pr-root">
        ...
        <div className="pr-card">
              ...
              <div>
                ...
                <div className="pr-meta">
                  {profile?.studentId && (
                    <span className="pr-meta-item">
                      <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                        <rect x="1" y="2" width="10" height="8" rx="1.5" stroke="#9bbcbc" strokeWidth="1.2"/>
                        <path d="M4 5h4M4 7h2" stroke="#9bbcbc" strokeWidth="1.2" strokeLinecap="round"/>
                      </svg>
                  ...
                  {profile?.roomNumber && (
                    <span className="pr-meta-item">
                      <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                        <path d="M2 10V5l4-3 4 3v5" stroke="#9bbcbc" strokeWidth="1.2" strokeLinejoin="round"/>
                        <path d="M4.5 10V7.5h3V10" stroke="#9bbcbc" strokeWidth="1.2" strokeLinejoin="round"/>
                      </svg>
                      {profile.block ? `${profile.block}, ` : ""}Room {profile.roomNumber}
                    </span>
                  )}
                  <span className="pr-meta-item">
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                      <path d="M1 3l5 3.5L11 3" stroke="#9bbcbc" strokeWidth="1.2" strokeLinecap="round"/>
                      <rect x="1" y="2" width="10" height="8" rx="1.5" stroke="#9bbcbc" strokeWidth="1.2"/>
                    </svg>
                    {user?.email}
                  </span>
                ...
                <div className="pr-badges">
                  {profile?.status && (
                    <span className="pr-badge pr-badge-teal">{profile.status}</span>
                  )}
                  {profile?.yearOfStudy && (
                    <span className="pr-badge pr-badge-orange">{profile.yearOfStudy}</span>
                  )}
                  {!profile?.status && !profile?.yearOfStudy && (
                    <span
                      style={{ fontSize: "12px", color: "#b8d4d4", fontStyle: "italic", cursor: "pointer" }}
            ...
            <div className="pr-header-right">
              <button className="pr-edit-btn" onClick={() => setShowEdit(true)}>
                <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
                  <path d="M9.5 2.5l1 1-7 7-1.5.5.5-1.5 7-7z" stroke="#fff" strokeWidth="1.3" strokeLinejoin="round"/>
                </svg>
                Edit Profile
              </button>
              <button
              ...
              >
                <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
                  ...
                  <path d="M8.5 9L11.5 6.5 8.5 4M11.5 6.5H5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                Log Out
              </button>
            </div>
          ...
          <div className="pr-stats">
            <div className="pr-stat">
              <div className="pr-stat-icon" style={{ background: "rgba(45,189,170,0.1)" }}>
                <svg width="18" height="18" viewBox="0 0 16 16" fill="none">
                  <path d="M9 1H4a1 1 0 00-1 1v12a1 1 0 001 1h8a1 1 0 001-1V6L9 1z" stroke="#2dbdaa" strokeWidth="1.3" strokeLinejoin="round"/>
                  <path d="M9 1v5h5" stroke="#2dbdaa" strokeWidth="1.3" strokeLinejoin="round"/>
                </svg>
              </div>
              <div>
            ...
            <div className="pr-stat">
              <div className="pr-stat-icon" style={{ background: "rgba(245,166,35,0.1)" }}>
                <svg width="18" height="18" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="6.5" stroke="#f5a623" strokeWidth="1.3"/>
                  <path d="M8 4.5V8l2.5 2.5" stroke="#f5a623" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <div>
            ...
            <div className="pr-stat">
              <div className="pr-stat-icon" style={{ background: "rgba(45,189,170,0.1)" }}>
                <svg width="18" height="18" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="6.5" stroke="#2dbdaa" strokeWidth="1.3"/>
                  <path d="M5 8l2.5 2.5L11 5.5" stroke="#2dbdaa" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <div>
        ...
        <div className="pr-panels">
          ...
          <div className="pr-panel">
            <div className="pr-panel-title">
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                <circle cx="7" cy="5" r="3" stroke="#2dbdaa" strokeWidth="1.3"/>
                <path d="M1.5 13c0-3 2.5-4.5 5.5-4.5s5.5 1.5 5.5 4.5" stroke="#2dbdaa" strokeWidth="1.3" strokeLinecap="round"/>
              </svg>
              Personal Information
            </div>
            {loadingProfile ? (
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                {[1,2,3,4].map(i => (
                  <div key={i}>
                    <div className="pr-skeleton" style={{ width: "40%", height: 10, marginBottom: 6 }}/>
              ...
              <div className="pr-info-grid">
                <InfoField label="Full Name" value={profile?.displayName || user?.displayName} />
          ...
          <div className="pr-panel">
            <div className="pr-panel-title">
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                <path d="M2 12V6l5-4 5 4v6" stroke="#2dbdaa" strokeWidth="1.3" strokeLinejoin="round"/>
                <path d="M5 12V9h4v3" stroke="#2dbdaa" strokeWidth="1.3" strokeLinejoin="round"/>
              </svg>
              Hostel Information
            </div>
            {loadingProfile ? (
      ...
      <div className="epm-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
        <div className="epm-modal">
            ...
            <div>
              ...
              <div className="epm-grid">
                <div className="epm-field" style={{ gridColumn: "1 / -1" }}>
                  ...
                  <input className="epm-input" name="displayName"
                    value={fields.displayName} onChange={handleChange}
                    placeholder="e.g. Alex Johnson" />
                </div>
                <div className="epm-field">
                  <label className="epm-label">Student ID</label>
                  <input className="epm-input" name="studentId"
                    value={fields.studentId} onChange={handleChange}
                    placeholder="e.g. STU 2021 0402" />
                </div>
                <div className="epm-field">
                  <label className="epm-label">Phone Number</label>
                  <input className="epm-input" name="phoneNumber"
                    value={fields.phoneNumber} onChange={handleChange}
                    placeholder="e.g. +233 24 000 0000" />
                </div>
                <div className="epm-field">
                  <label className="epm-label">Date of Birth</label>
                  <input className="epm-input" name="dateOfBirth" type="date"
                    value={fields.dateOfBirth} onChange={handleChange} />
                </div>
                <div className="epm-field">
                  <label className="epm-label">Gender</label>
                  <select className="epm-select" name="gender"
            ...
            <div>
              ...
              <div className="epm-grid">
                <div className="epm-field">
                  ...
                  <select className="epm-select" name="yearOfStudy"
                    value={fields.yearOfStudy} onChange={handleChange}>
                ...
                <div className="epm-field">
                  ...
                  <select className="epm-select" name="status"
            ...
            <div>
              ...
              <div className="epm-grid">
                <div className="epm-field">
                  ...
                  <input className="epm-input" name="block"
                    value={fields.block} onChange={handleChange}
                    placeholder="e.g. Block A" />
                </div>
                <div className="epm-field">
                  <label className="epm-label">Room Number</label>
                  <input className="epm-input" name="roomNumber"
                    value={fields.roomNumber} onChange={handleChange}
                    placeholder="e.g. 402" />
                </div>
                <div className="epm-field">
                  <label className="epm-label">Check-in Date</label>
                  <input className="epm-input" name="checkInDate" type="date"
                    value={fields.checkInDate} onChange={handleChange} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="epm-footer">
            <button className="epm-cancel" onClick={onClose}>Cancel</button>
